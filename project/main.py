...
app.config.update(
     ...
     MAIL_PORT='465',
     MAIL_USE_SSL=True,
     MAIL_USERNAME='alagu.rar@gmail.com',
     MAIL_PASSWORD='Rajammal@_1234'
 )
mail = Mail(app)
...
app.config['SQLALCHEMY_DATABASE_URI']='mysql://root:vishali@localhost/covid'
db=SQLAlchemy(app)
...
def hospitalUser():
    ...
    if('user' in session and session['user']=="admin"):
        ...
        if request.method=="POST":
            ...
            # mail.send_message('COVID CARE CENTER',sender=['gmail-user'],recipients=[email],body=f"Welcome thanks for choosing us\nYour Login Credentials Are:\n Email Address: {email}\nPassword: {password}\n\nHospital Code {hcode}\n\n Do not share your password\n\n\nThank You..." )
